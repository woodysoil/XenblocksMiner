...
- The auto policy now selects chunk `16` for generated-key d1 CUDA batches and chunk `32` for generated-key d8 CUDA batches with at least 1024 attempts. Miner-generated CUDA batches opt into this policy while explicit CLI static and manual dynamic chunk behavior remains preserved.
- A d1/d64 scan found manual dynamic chunk `16` promising for both difficulty values, but the rebuilt d64 auto confirmation was inconsistent. Keep d64 out of the automatic policy until a longer same-settings confirmation is stable and positive.
