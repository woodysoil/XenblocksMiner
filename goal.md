...
- The auto policy now selects chunk `16` for generated-key d1 CUDA batches, chunk `32` for d8 batches, and chunk `16` for d64 batches with at least 1024 attempts. Miner-generated CUDA batches opt into this policy while explicit CLI static and manual dynamic chunk behavior remains preserved.
