...
Current conservative defaults are `512` attempts through difficulty `1`, `3072` attempts through difficulty `8`, and `512` attempts through difficulty `64`. Treat these as starting points for future autotuning, not universal hardware limits.
