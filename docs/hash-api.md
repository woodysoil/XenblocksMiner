...
For larger GPUs or deeper tuning, use repeated `--scan-difficulty`, `--scan-batch-size`, and `--scan-first-block-workers` options to generate a custom matrix without editing the script.
